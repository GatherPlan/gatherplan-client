...
@template(
    route="/join_meeting_change_meeting_check",
    header_url="/join_meeting_change_meeting",
    page_text="",
)
def join_meeting_change_meeting_check() -> rx.Component:
    return rx.center(
        rx.vstack(
            rx.vstack(
                main_sub_text_center_box(
                    "변경한 약속 참여 정보를 확인해주세요.",
                    "변경하기를 눌러 약속 변경을 완료주세요.",
                ),
            ),
            rx.vstack(
